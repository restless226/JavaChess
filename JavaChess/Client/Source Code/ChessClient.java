...
public class ChessClient extends JFrame {
    ...
    public static int playerColor = 0;                        // will let client know whether it is the white or
    // black pieces
    ...
    public static void enableMoves() throws RemoteException {
        ...
        if (selectionX >= 0 && selectionX <= 7 && selectionY >= 0 && selectionY <= 7) {
            ...
            if (playerColor == 1) {
                if (!(j == 0) && Objects.equals(sesh[gameSessionSelected].getPieceTypeAt(selectionX, selectionY),
                        "Pawn")) {
                ...
                if (!(j == 7) && Objects.equals(sesh[gameSessionSelected].getPieceTypeAt(selectionX, selectionY),
                        "Pawn")) {
